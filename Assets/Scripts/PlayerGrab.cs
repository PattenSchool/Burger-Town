...
public class PlayerGrab : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        if (grabObject)
        {
            ...
            if (Vector3.Distance(grabObject.transform.position, test.transform.position) > 0.05f)
            {
                //print(grabObject.GetComponent<Rigidbody>().useGravity);
                Vector3 moveDirection = (test.transform.position - grabObject.transform.position);
            ...
            else if (Vector3.Distance(grabObject.transform.position, test.transform.position) < 0.05f)
            {
    ...
    void Grab()
    {
        ...
        if (grabObject)
        {
            grabObject.transform.parent = test.transform;
