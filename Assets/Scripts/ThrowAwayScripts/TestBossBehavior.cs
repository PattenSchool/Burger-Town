...
public class TestBossBehavior : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (this.gameObject.ToString() == "Idle (UnityEngine.GameObject)")
        {
        ...
        if (this.gameObject.ToString() == "Hostile (UnityEngine.GameObject)")
        {
        ...
        if (this.gameObject.ToString() == "Hostile Into Idle (UnityEngine.GameObject)")
        {
        ...
        if (this.gameObject.ToString() == "Distracted (UnityEngine.GameObject)")
        {
        ...
        if (this.gameObject.ToString() == "Death (UnityEngine.GameObject)")
        {
